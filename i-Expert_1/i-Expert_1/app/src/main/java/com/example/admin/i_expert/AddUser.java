...
public class AddUser extends AppCompatActivity {
    ...
    public void addData(View v) {
                ...
                if (Etd.getText().toString().equals("") || Ed1.getText().toString().equals("") || Ed3.getText().toString().equals("")) {
                    Toast.makeText(AddUser.this, "veuillez s'il vous plait remplir tous champs", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (DtInsert == true) {
                        Toast.makeText(AddUser.this, "votre compte a été créé avec succès", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(AddUser.this, "votre compte n'est pas créé", Toast.LENGTH_SHORT).show();
                    }
                }
